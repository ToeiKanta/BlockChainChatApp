...
# blockchain.mine(Block("Block 4"))
# blockchain.mine(Block("Block 5"))
# blockchain.mine(Block("Block 6"))
# print("\n\n\n\n")

# genesisBlock = blockchain.head
# print("==== start show original data =====")
# #print out each block in the blockchain
# while blockchain.head != None:
#     print(blockchain.head)
#     blockchain.head = blockchain.head.next
# print("==== end show original data =====\n")

# blockchain.head = genesisBlock
# #print out each block in the blockchain
# if(blockNoToEdit < 6):
#     i=0
#     for x in range(blockNoToEdit):
#         blockchain.head = blockchain.head.next
#         i+=1
#     print("==========================")
